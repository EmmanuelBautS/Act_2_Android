...
void main() => runApp(BBVAApp());

class BBVAApp extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/EmmanuelBautS/Act_2_Android/main/Fondo%201.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
